    ...
    <div className="min-h-screen  py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="w-50 h-1 bg-gradient-to-r from-blue-500 to-purple-600 mx-auto rounded-full"></div>
        </div>
          ...
          {courses.map((course) => (
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden rounded-t-2xl bg-white">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-b from-blue-300/20 to-transparent pointer-events-none"></div>
              </div>
