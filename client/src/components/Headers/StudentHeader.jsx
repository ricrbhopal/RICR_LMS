          ...
          <div className="flex justify-between">
            <div className="flex gap-3">
              ...
              <div className="flex items-center gap-4 ">
                ...
                <div>
                  <button
                    className="relative px-4 py-2 bg-blue-100 text-blue-700 rounded-sm hover:bg-blue-600 hover:text-white flex items-center gap-2 border-2 hover:border-blue-600"
